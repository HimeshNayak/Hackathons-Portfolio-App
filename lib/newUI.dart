            ...
            child: Container(
              ...
              child: Column(
                children: <Widget>[
                  TabBar(
                    tabs: <Widget>[
                      Tab(child: Icon(Icons.book, color: Colors.grey.shade700)),
                      Tab(child: Icon(Icons.code, color: Colors.grey.shade700)),
                      Tab(child: Icon(Icons.link, color: Colors.grey.shade700)),
                      Tab(
                          child:
